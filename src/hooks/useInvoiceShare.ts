  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const invoice: Invoice = {
        ...
        language: result.invoice.language,
        locale: result.invoice.locale,
        bank_account_id: result.invoice.bank_account_id,
        payment_account_label: result.invoice.payment_account_label,
        payment_account_number: result.invoice.payment_account_number,
        payment_iban: result.invoice.payment_iban,
        payment_swift_bic: result.invoice.payment_swift_bic,
        payment_currency: result.invoice.payment_currency,
